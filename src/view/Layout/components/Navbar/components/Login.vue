  ...
  <div class="login_box">
    <div class="login_container">
      ...
      <div class="login_title">
        <h3>
          欢迎回来{{ userInfos.user_name ? "，" + userInfos.user_name : "" }}
        </h3>
      </div>
      <!-- 登录标题 -->
...
const qrLoginInit = async (flag = true) => {
  ...
  qrTimer = setInterval(async () => {
    ...
    if (data.code === 800) {
      ...
      if (document.cookie) {
        document.cookie =
          "url=MUSIC_A; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;";
        document.cookie =
          "url=NMTID; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;";
      }
      qrStatus.value = "待确认";
