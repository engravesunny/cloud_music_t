      ...
      <div class="top">
        ...
        <div class="options_left">
          <div class="img">
            <el-image
              ...
              :style="{ opacity }"
              fit="cover"
              :src="http2Https(FMInfo[index].album.picUrl + '?params=100y100')"
              alt="img"
              @load="opacity = 1"
            />
            <div class="playbtn" />
          ...
          <div class="btn">
            ...
            <button class="iconfont" @click="playIt">
              <span>&#xe87c;</span>
            </button>
            <button class="iconfont" @click="nextFM">
              <span>&#xe63e;</span>
            </button>
          </div>
        </div>
        ...
        <div class="songInfo_right">
          <div class="songInfo">
            ...
            <div class="other">
              <div class="ablum shenglue" :title="FMInfo[index].album.name">
              ...
              >
                歌手: {{ mulArShow(FMInfo[index].artists) }}
              </div>
            </div>
          </div>
          <song-text
