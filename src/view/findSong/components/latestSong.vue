        ...
        <template #item="{ item, col }">
          <div class="song-list-item" @dblclick="handlePlayClick(col.content)">
            <div class="left">
              ...
              <div class="img">
                <el-image
                  :src="http2Https(col.content.album.picUrl + '?params=60y60')"
                  class="opacity"
                  @load="handleLoad"
                />
                <div
                  class="playBtn iconfont"
                  @click="handlePlayClick(col.content)"
                >
                  &#xe87c;
                </div>
              </div>
