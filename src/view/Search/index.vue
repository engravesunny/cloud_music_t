    ...
    <el-scrollbar ref="scrollbar">
        <div class="search_container unselectable">
            ...
            <div class="search_result">
                <keep-alive>
                    <component v-loading="!searchResult.length" :is="searchTypeComponent" :currentPages="searchPage"
                        :result="searchResult" :songTotal="songTotal" @updatePage="changePage"
                        :search-value="route.query.searchValue"></component>
                </keep-alive>
            </div>
            <!-- 搜索结果 -->
