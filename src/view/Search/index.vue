      ...
      <div class="search_type_option">
        <ul class="type_list">
          <li
            ...
            @click="(e) => changeSearchType(e)"
          >
            单曲
          </li>
          <li
            :class="{ active: searchType === 1000 }"
            @click="(e) => changeSearchType(e)"
          >
            歌单
          </li>
          <li
            :class="{ active: searchType === 100 }"
            @click="(e) => changeSearchType(e)"
          >
            歌手
          </li>
          <li
            :class="{ active: searchType === 10 }"
            @click="(e) => changeSearchType(e)"
          >
            专辑
          </li>
      ...
      <div class="search_result">
        <keep-alive>
          <component
            ...
            v-loading="!searchResult.length"
            :current-pages="searchPage"
            :result="searchResult"
            :song-total="songTotal"
            :search-value="route.query.searchValue"
